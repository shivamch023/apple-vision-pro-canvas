...
// jo video ke upar text hai scroll karne par top par chla jaye
...
function canvas1() {
    ...
    function files(index) {
        var data = `please addd image canvasb imagess`; ///please addd canvas image 
        return data.split("\n")[index];
    }
